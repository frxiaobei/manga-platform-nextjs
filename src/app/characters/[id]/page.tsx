    ...
    <div className="mx-auto max-w-[1400px] px-4 sm:px-6 py-10 sm:py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          {/* Admin Review Panel */}
          {user?.role === "ADMIN" && (
            <div className="mb-8 p-6 bg-white/5 rounded-[2rem] border border-ansha/20 space-y-4">
              <h3 className="text-lg font-semibold text-ansha">管理员审核</h3>
              
              <div className="space-y-2">
                <label className="text-sm text-white/40">审核意见 / 理由 (拒绝或需修改时必填)</label>
                <textarea
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-ansha min-h-[100px]"
                  placeholder="请输入理由..."
                  value={reason}
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button 
                  ...
                  className="bg-green-600 hover:bg-green-700 text-xs h-10 rounded-xl"
                >
                  通过
                </Button>
                <Button 
                  ...
                  disabled={reviewLoading}
                  className="bg-yellow-600 hover:bg-yellow-700 text-xs h-10 rounded-xl"
                >
                  需修改
                </Button>
                <Button 
                  ...
                  disabled={reviewLoading}
                  className="bg-red-600 hover:bg-red-700 text-xs h-10 rounded-xl"
                >
                  拒绝
                </Button>
              </div>
