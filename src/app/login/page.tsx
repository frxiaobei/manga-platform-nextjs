      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6 mb-7 sm:mb-8">
          ...
          {!isRegister && (
            <div className="flex justify-end">
              <Link href="/forgot-password" size="sm" className="text-xs font-bold uppercase tracking-widest text-white/20 hover:text-ansha transition-all">
                忘记密码？
              </Link>
            </div>
          )}
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-xs uppercase tracking-widest">
            <span className="bg-zinc-950 px-4 text-white/20">或者通过</span>
          </div>
        </div>
